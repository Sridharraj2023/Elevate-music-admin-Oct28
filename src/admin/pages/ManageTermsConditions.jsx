...
function ManageTermsConditions() {
  ...
  const handlePublish = async (id) => {
    if (!window.confirm('Publish this version as active? This will replace the current active version.')) return;
  ...
  const handleDelete = async (id) => {
    if (!window.confirm('Delete this terms version? This cannot be undone.')) return;
